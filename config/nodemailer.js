...
let transporter = nodemailer.createTransport({
    ...
    let infoEmail = await transporter.sendMail({
        ...
        <tr>
        <td align="center">
        <img height="auto" src="https://i.postimg.cc/7L2Ndzzd/logo-2-b-3.png" style="display:block;border:0px;text-decoration:none;border-style:none;color:#ffffff;border-width:0" width="99" class="CToWUd" data-bit="iit">
        </td>
        </tr>
        <tr>
        <td height="32" style="height:32px;min-height:32px;line-height:32px;font-size:1px">
